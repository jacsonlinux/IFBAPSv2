...
export class SchedulesService {
  ...
  addEquipment() {
    const equipments = [
      {description: 'agitador', exist: true},
      {description: 'agitador magnético', exist: true},
      {description: 'agitador magnético com aquecedor', exist: true},
      {description: 'autoclave', exist: true},
      {description: 'balança', exist: true},
      {description: 'balança analítica', exist: true},
      {description: 'balança digital de cozinha', exist: true},
      {description: 'balança semi-analítica', exist: true},
      {description: 'banho maria', exist: true},
      {description: 'banho ultratermostático', exist: true},
      {description: 'batedeira planetária', exist: true},
      {description: 'bomba de vácuo', exist: true},
      {description: 'bomba de vácuo sl60', exist: true},
      {description: 'bureta automática', exist: true},
      {description: 'cabine de segurança biológica', exist: true},
      {description: 'calorímetro', exist: true},
      {description: 'capela', exist: true},
      {description: 'capela de exaustão de gases', exist: true},
      {description: 'capela para exaustão de gases', exist: true},
      {description: 'centrífuga', exist: true},
      {description: 'centrífuga para eppendorf', exist: true},
      {description: 'centrífuga para tubos', exist: true},
      {description: 'chapa de aquecimento', exist: true},
      {description: 'cilíndro', exist: true},
      {description: 'condutivímetro', exist: true},
      {description: 'congelador vertical', exist: true},
      {description: 'contador de colônias', exist: true},
      {description: 'controlador de temperatura', exist: true},
      {description: 'cromatógrafo a gás perkinelmer', exist: true},
      {description: 'defumadeira vertical', exist: true},
      {description: 'destilador de álcool', exist: true},
      {description: 'destilador de nitrogênio', exist: true},
      {description: 'desumidificador', exist: true},
      {description: 'espectrofotômetro', exist: true},
      {description: 'espectrofotômetro infravermelho shimadzu', exist: true},
      {description: 'espremedor', exist: true},
      {description: 'estabilizador', exist: true},
      {description: 'estufa', exist: true},
      {description: 'estufa bacteriológica', exist: true},
      {description: 'estufa com circulação de ar', exist: true},
      {description: 'estufa de esterilização e secagem', exist: true},
      {description: 'estufa microprocessada para esterilização e secagem', exist: true},
      {description: 'exaustor de gases', exist: true},
      {description: 'extrator de suco', exist: true},
      {description: 'fogão industrial 4 bocas', exist: true},
      {description: 'forno elétrico', exist: true},
      {description: 'forno industrial', exist: true},
      {description: 'forno mufla', exist: true},
      {description: 'freezer horizontal duas tampas', exist: true},
      {description: 'freezer vertical', exist: true},
      {description: 'geladeira', exist: true},
      {description: 'homogeneizador de amostras', exist: true},
      {description: 'hplc shimadzu', exist: true},
      {description: 'incubadora bod', exist: true},
      {description: 'incubadora com agitação horbital', exist: true},
      {description: 'incubadora com fotoperíodo', exist: true},
      {description: 'liquidificador industrial', exist: true},
      {description: 'liquidificador simples', exist: true},
      {description: 'macaco elevatório', exist: true},
      {description: 'manta de aquecimento', exist: true},
      {description: 'máquina de gelo', exist: true},
      {description: 'medidor de ph', exist: true},
      {description: 'mesa', exist: true},
      {description: 'microondas', exist: true},
      {description: 'microscópio', exist: true},
      {description: 'moedor de carne', exist: true},
      {description: 'moinho de facas', exist: true},
      {description: 'pelletizadora', exist: true},
      {description: 'phmetro', exist: true},
      {description: 'picador de carne', exist: true},
      {description: 'placa de aquecimento', exist: true},
      {description: 'ponto de fluidez e névoa', exist: true},
      {description: 'ponto de fulgor', exist: true},
      {description: 'ponto de fusão', exist: true},
      {description: 'prensa', exist: true},
      {description: 'ralador', exist: true},
      {description: 'reator', exist: true},
      {description: 'refresqueira dupla', exist: true},
      {description: 'refresqueira simples', exist: true},
      {description: 'rotaevaporador', exist: true},
      {description: 'rotavapor', exist: true},
      {description: 'usina de iodiesel didática', exist: true},
      {description: 'viscosímetro copo ford', exist: true},
      {description: 'vortex', exist: true}
    ];
  ...
  addReagent() {
    const reagent = [
      ...
      {description: 'piridil-resorcina sal monosódico', exist: true},
      ...
      {description: 'acetato de sódio', exist: true},
      {description: 'acetato de sódio trihidratado', exist: true},
      {description: 'acetona', exist: true},
      {description: 'ácido (orto)periodico', exist: true},
      ...
      {description: 'ácido fosfórico', exist: true},
      ...
      {description: 'ácido perclórico', exist: true},
      ...
      {description: 'álcool benzilíco', exist: true},
      {description: 'álcool etílico 95%', exist: true},
      ...
      {description: 'azida de sódio', exist: true},
      {description: 'azida de sódio solução 10%', exist: true},
      {description: 'azul de alcian', exist: true},
      ...
      {description: 'borohidreto de sódio', exist: true},
      ...
      {description: 'butanol -1', exist: true},
      {description: 'butanol -2', exist: true},
      ...
      {description: 'cloramina t', exist: true},
      ...
      {description: 'cloreto de bário dihidratado', exist: true},
      {description: 'cloreto de bário', exist: true},
      ...
      {description: 'cloreto de ferro lll (ico)', exist: true},
      ...
      {description: 'dimetilglioxima', exist: true},
      ...
      {description: 'hexano (solvente recuperado)', exist: true},
      ...
      {description: 'nitrato de amônio', exist: true},
      ...
      {description: 'óxido de alumínio', exist: true},
